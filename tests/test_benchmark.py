...
def test_latency_breakdown_sums():
    ...
    lb = LatencyBreakdown(
        load_ms=10.0, preprocess_ms=20.0, vision_prefill_ms=30.0, decode_ms=100.0, postprocess_ms=5.0, total_ms=0.0
    )
...
def test_measure_run_throughput_and_speedup():
    ...
    timings = [LatencyBreakdown(10, 20, 30, 100, 5, 165) for _ in range(100)]
